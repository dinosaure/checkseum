...
(*$T crc32c_bigstring
   crc32c_bigstring (Cstruct.to_bigarray @@ Cstruct.of_string "123456789") 0 9 = 0xe3069283l
   crc32c_bigstring (Cstruct.to_bigarray @@ Cstruct.of_string "Thou hast made me, and shall thy work decay?") 0 44 = 0x866374c0l
 *)
let crc32c_bigstring =
...
(*$T crc32c_string
   ...
   crc32c_string "Thou hast made me, and shall thy work decay?" 0 44 = 0x866374c0l
 *)
let crc32c_string =
